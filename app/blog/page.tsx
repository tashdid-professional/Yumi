    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="py-20 md:py-24 container">
        ...
        <div className="mt-24 md:mt-32 flex justify-center items-center gap-4">
          <button className="w-10 h-10 flex items-center justify-center rounded-full border border-neutral-200 text-neutral-400 hover:border-black hover:text-black transition-all">
          ...
          <div className="flex items-center gap-2">
            <button className="w-10 h-10 flex items-center justify-center rounded-full bg-black text-white text-sm font-medium">
              1
            </button>
            <button className="w-10 h-10 flex items-center justify-center rounded-full border border-transparent text-neutral-400 hover:text-black text-sm font-medium transition-colors">
              2
            </button>
          </div>
